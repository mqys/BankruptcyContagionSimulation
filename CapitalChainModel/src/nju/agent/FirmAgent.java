...
import nju.agent.msg.AbstractMessage;
...
//		Logger.log_bankruptEvent(this.getID());
		...
		// simple demo
		// int conn[][] = SimulationDemo.connectionGraph;
		// for (int i = 0; i < conn.length; ++i){
		// 	if (i == Integer.valueOf(getID()))
		// 		continue;
		// 	if (conn[Integer.valueOf(getID())][i] == 1)
		// 		SimulationDemo.agentList.get(i).informAgent(new BankruptcyMessage(this, this.assetsCom.getCurrent_C(), false));
		// 	if (conn[i][Integer.valueOf(getID())] == 1)
		// 		SimulationDemo.agentList.get(i).informAgent(new BankruptcyMessage(this, this.assetsCom.getCurrent_C(), true));
		// }
